...
parser = argparse.ArgumentParser(description='Parameters for deep capsule networks.')
...
class CapsNet(nn.Module):
    def __init__(self, args):
        ...
        self.caps_layer5 = RoutingWithCombinedAttention(args.C, args.C, args.K, args.D, args.D, args.if_bias,
                                                        out_S=int(args.input_img_size / 2), stride=1)

        self.caps_layer6 = RoutingWithCombinedAttention(args.C, args.C, args.K, args.D, args.D, args.if_bias,
                                                        out_S=int(args.input_img_size / 4), stride=2)
        self.caps_layer7 = RoutingWithCombinedAttention(args.C, args.C, args.K, args.D, args.D, args.if_bias,
                                                        out_S=int(args.input_img_size / 4), stride=1)
        self.caps_layer8 = RoutingWithCombinedAttention(args.C, args.C, args.K, args.D, args.D, args.if_bias,
                                                        out_S=int(args.input_img_size / 4), stride=1)

        self.caps_layer9 = RoutingWithCombinedAttention(args.C, args.C, args.K, args.D, args.D, args.if_bias,
                                                        out_S=int(args.input_img_size / 8), stride=2)
        self.caps_layer10 = RoutingWithCombinedAttention(args.C, args.C, args.K, args.D, args.D, args.if_bias,
                                                         out_S=int(args.input_img_size / 8), stride=1)
        self.caps_layer11 = RoutingWithCombinedAttention(args.C, args.class_num, args.K, args.D, args.D, args.if_bias,
                                                         out_S=int(args.input_img_size / 8), stride=1)
...
def main(args):
    ...
    for epoch in range(0, args.epochs + 1):
        ...
        if acc > best_acc:
            best_acc = acc
            torch.save(model.state_dict(), os.path.join(args.save_dst, args.dataset + "Cdeep_best.pt"))
