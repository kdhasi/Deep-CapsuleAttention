...
class CapsNet(nn.Module):
    def __init__(self, args):
        ...
        self.caps_layer5 = RoutingWithSpatialAttention(args.C, args.class_num, args.K, args.D, args.D, args.if_bias,
...
def main(args):
    ...
    for epoch in range(0, args.epochs + 1):
        ...
        if acc > best_acc:
            best_acc = acc
            torch.save(model.state_dict(), os.path.join(args.save_dst, args.dataset + "Sbase_best.pt"))
